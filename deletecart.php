<?php
 ...
 $num_cart = $_GET['numcart']; // get id through query string
 $conn->begin_transaction();
 $query1 = "SELECT user_id,name_item,quant_item,num_categ, price_item FROM shoppingcart WHERE num_cart =  '$num_cart'  "; // select query
   //echo $query;
  ...
  if(isset($_POST['delete'])) // when click on Update button
  {
     ...
     $query ="DELETE  FROM shoppingcart  WHERE num_cart=  '$num_cart'";
     ...
     <main class="mainn">
         <form    method="POST">
             <div class="insertt">
                 ...
                 <div>
                 <label>user_id </label><input type="text" name="user_id" value="<?php echo $data['user_id'] ?>" size="3" disabled>   
                  </div>
                 <div>
